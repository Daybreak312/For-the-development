    ...
    return (
        <main
            ...
            <div className={"flex flex-col gap-[20px]"}>
                ...
                <p className={"font-p-medium text-[28px] text-white text-right"}>
                    - {quote[1]}
                </p>
            </div>
            <div className={"flex flex-col gap-[10px]"}>
                <p className={"font-p-medium text-[32px] text-white text-center"}>
                ...
                <div
                    className={"flex justify-center items-center p-[10px] h-[102px] w-[1024px] bg-[#333333] rounded-[100px]"}>
                    <div
